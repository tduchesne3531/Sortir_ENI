 ...
 */
final class Version20250123102207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, site_id INT DEFAULT NULL, place_id INT DEFAULT NULL, manager_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, date_start_time DATETIME NOT NULL, duration INT DEFAULT NULL, registration_dead_line DATE DEFAULT NULL, max_registration INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, INDEX IDX_AC74095A5D83CC1 (state_id), INDEX IDX_AC74095AF6BD1646 (site_id), INDEX IDX_AC74095ADA6A219 (place_id), INDEX IDX_AC74095A783E3463 (manager_id), INDEX IDX_AC74095AB03A8386 (created_by_id), INDEX IDX_AC74095A896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
